            ...
            <div class="the-header col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="header-logo-container col-xl-3 col-lg-3 col-md-4 col-sm-4 col-4">
                            <a class="header-logo" href="<?php echo home_url('/');?>" title="<?php echo get_bloginfo('name'); ?>">
                        ...
                        <div class="header-navbar col-xl-7 col-lg-7 col-md-4 col-sm-4 col-4">
                        ...
                        <div class="header-search col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4">
                            <?php //get_search_form(); ?>
                        </div>
