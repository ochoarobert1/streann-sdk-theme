...
function streann_sdk_load_css() {
    ...
    if (!is_admin()){
        ...
        /*- MAIN STYLE -*/
        wp_register_style('autocomplete-style', get_template_directory_uri() . '/css/jquery.auto-complete.css', false, $version_remove, 'all');
        wp_enqueue_style('autocomplete-style');

        /*- MAIN STYLE -*/
        wp_register_style('main-style', get_template_directory_uri() . '/css/streann_sdk-style.css', false, $version_remove, 'all');
        wp_enqueue_style('main-style');

        /*- MAIN MEDIAQUERIES -*/
        wp_register_style('main-mediaqueries', get_template_directory_uri() . '/css/streann_sdk-mediaqueries.css', array('main-style'), $version_remove, 'all');
...
add_action('wp_enqueue_scripts', 'streann_sdk_load_css');
