...
function streann_sdk_load_js() {
    ...
    if (!is_admin()){
        ...
        /*- AUTOCOMPLETE -*/
        wp_register_script('autocomplete-js', get_template_directory_uri() . '/js/jquery.auto-complete.min.js', array('jquery'), $version_remove, true);
        ...
        wp_localize_script( 'main-functions', 'admin_url',
                           array(
...
add_action('wp_enqueue_scripts', 'streann_sdk_load_js');
